...
np.savetxt(string_savename + '_y'+ '.txt',coordiante_dict['vlist_y'])
np.savetxt(string_savename + '_z'+ '.txt',coordiante_dict['vlist_z'])
np.savetxt(string_savename + 'dfmax'+ '.txt',dummy_parameter2['df_list_max'])
