...
half_filling_angle = 13 # half filling angle in °
S = 0.17 # dimensionless seperation distance
...
string_savename     = 'half_fillingangle'+ str(half_filling_angle) + 'contact_angle' + str(theta_p) + '_d'+ str(rounded_diameter) + 'mm_' + 'l' + str(rounded_length) + 'mm_'  + 'iteration' +str(iteration_max) + '_refinement'+str(refinement)
