...
gamma = 72.8e-3  # N/m, surface tension of di-n-butyl phthalate/liquid paraffin mixture
...
string_savename     = 'gamma72_'+'contact_angle' + str(rounded_theta_p) + '_d'+ str(rounded_diameter) + 'mm_' + 'l' + str(rounded_length) + 'mm_'  + 'iteration' +str(iteration_max) + '_refinement'+str(refinement)
