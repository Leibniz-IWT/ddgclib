#!/usr/bin/env python3
"""Case #3: Fig. 6 approach with capped contact-line motion to remove late Cauchy spikes."""
...
def build_config(core, args):
    ...
    return replace(
        ...
        name=CASE_NAME,
        title=(
            "Pitois 2000 Fig. 6 approach: Case #3 raw force with "
            "constant lubrication pressure and capped contact-line motion"
        ),
