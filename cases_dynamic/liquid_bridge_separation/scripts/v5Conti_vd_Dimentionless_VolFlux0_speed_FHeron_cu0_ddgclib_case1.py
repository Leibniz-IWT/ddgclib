"""Case 1: rCL = 1.540 mm compressible edge-flux baseline."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "1"
CASE_TITLE = "rCL = 1.540 mm, compressible, edge-flux viscous force"
...
def output_process() -> str:
    return "write case1 output, record every 100 steps, mesh PNG every 100 steps"
