"""Case 10: rCL = 1.540 mm incompressible with PR33 pressure force."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "10"
CASE_TITLE = "rCL = 1.540 mm, incompressible, PR33 zero gauge"
...
def output_process() -> str:
    return "write case10 output, record every step, mesh PNG every 100 steps"
