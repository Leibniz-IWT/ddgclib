"""Case 11: rCL = 1.540 mm PR33 pressure force with Heron reference."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "11"
CASE_TITLE = "rCL = 1.540 mm, compressible label, PR33 Heron gauge"
...
def optional_force_process() -> str:
    return "call PR33 operator path, add Fp = B^T p, use p_ref = p_Heron, hydrostatic top reference on"
...
def output_process() -> str:
    return "write case11 output, record every step, mesh PNG every 100 steps"
