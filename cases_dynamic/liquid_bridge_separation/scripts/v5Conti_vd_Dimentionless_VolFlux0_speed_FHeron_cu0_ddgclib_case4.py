"""Case 4: rCL = 1.486 mm incompressible counterpart."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "4"
CASE_TITLE = "rCL = 1.486 mm force-calibrated mesh, incompressible"
...
def output_process() -> str:
    return "write case4 output, record every step, mesh PNG every 100 steps"
