"""Case 6: rCL = 1.540 mm incompressible with tetrahedral Cauchy viscosity."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "6"
CASE_TITLE = "rCL = 1.540 mm, incompressible, tetrahedral Cauchy viscous force"
...
def output_process() -> str:
    return "write case6 output, record every 100 steps, mesh PNG off"
