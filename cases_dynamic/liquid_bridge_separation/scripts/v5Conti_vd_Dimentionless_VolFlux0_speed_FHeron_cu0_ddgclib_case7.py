"""Case 7: rCL = 1.540 mm compressible with hydrostatic top contact reference."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "7"
CASE_TITLE = "rCL = 1.540 mm, compressible, edge-flux plus hydrostatic force"
...
def output_process() -> str:
    return "write case7 output, record every step, mesh PNG every 100 steps"
