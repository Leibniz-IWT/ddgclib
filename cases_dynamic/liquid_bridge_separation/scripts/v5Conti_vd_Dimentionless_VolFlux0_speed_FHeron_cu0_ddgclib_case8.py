"""Case 8: rCL = 1.540 mm incompressible with hydrostatic top contact reference."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "8"
CASE_TITLE = "rCL = 1.540 mm, incompressible, edge-flux plus hydrostatic force"
...
def optional_force_process() -> str:
    return "PR33 pressure force off, hydrostatic force on with top contact reference"
...
def output_process() -> str:
    return "write case8 output, record every step, mesh PNG every 100 steps"
