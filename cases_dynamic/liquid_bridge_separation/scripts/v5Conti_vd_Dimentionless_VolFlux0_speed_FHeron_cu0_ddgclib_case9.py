"""Case 9: rCL = 1.540 mm compressible label with PR33 pressure force."""

from _ddgclib_case_runner import run_case, show_case_process


CASE_ID = "9"
CASE_TITLE = "rCL = 1.540 mm, compressible label, PR33 zero gauge"
...
def output_process() -> str:
    return "write case9 output, record every step, mesh PNG every 100 steps"
