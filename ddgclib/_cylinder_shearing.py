...
def cylinder_shearing_N(r, theta_p, gamma, abc ,shear,angle,u_l, u_u, v_l,v_u, refinement=2, cdist=1e-10, equilibrium=True):
  ...
  #  u = 0.0    # [-2, 2.0
    ...
    def catenoid(u, v):
        ...
        #x = -np.sin(angle)*z1 +np.cos(angle) *x1
        #y = y1
        #z = np.cos(angle) *z1 + np.sin(angle) *x1
